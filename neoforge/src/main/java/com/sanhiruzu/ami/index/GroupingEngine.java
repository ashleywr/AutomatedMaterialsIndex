...
public class GroupingEngine {
    ...
    public static void initialize(net.minecraft.world.level.Level level) {
        ...
        try {
            ...
            com.sanhiruzu.ami.neoforge.AMI.LOGGER.warn("GroupingEngine: Failed to build Stonecutter heuristics", e);
        }
    }
    ...
    public static String classifyShape(ItemStack stack) {
        ...
        if (stack.has(net.minecraft.core.component.DataComponents.FOOD)) return "food";
    ...
    private static int getTopologyPriority(Item item) {
        ...
        return switch (path) {
            ...
            case "stone" -> 950;
            case "dirt" -> 900;
            case "oak_log", "spruce_log", "birch_log", "jungle_log", "acacia_log", "dark_oak_log", "mangrove_log", "cherry_log", "crimson_stem", "warped_stem" -> 850;
            case "sand" -> 800;
            case "gravel" -> 750;
    ...
    private static void buildTopology() {
        ...
        Set<Item> blacklist = new HashSet<>(Arrays.asList(
                ...
                Items.PRISMARINE_CRYSTALS, Items.TURTLE_SCUTE, // Items.ARMADILLO_SCUTE,
