...
public class EmiIntegrationLoader {
    ...
    public static void indexEmiRecipes(
            ConcurrentMap<Item, List<RecipeHolder<?>>> recipesByOutput,
            ConcurrentMap<Item, List<RecipeHolder<?>>> recipesByInput,
        ...
        try {
            ...
            for (var entry : recipesByCat.entrySet()) {
                ...
                for (Object capturedObj : entry.getValue()) {
                    try {
                        ...
                        com.sanhiruzu.ami.AMI.LOGGER.debug("Failed to index EMI recipe", e);
                    }
                }
            }
            ...
            com.sanhiruzu.ami.AMI.LOGGER.debug("AMI/EMI bridge loading failed", e);
        }
    }
}
