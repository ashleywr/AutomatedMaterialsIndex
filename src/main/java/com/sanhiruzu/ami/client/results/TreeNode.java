...
public class TreeNode {
    ...
    public boolean isModGroup() {
        return modGroup;
    }

    public void setModGroup(boolean modGroup) {
    ...
    public int getItemCountOverride() {
        return itemCountOverride;
    }

    public void setItemCountOverride(int itemCountOverride) {
