...
public class ResultsProcessor {
    ...
    public enum SortField {
        ...
        GREGTECH_EU("ami.sort.gregtech_eu", true),
        GREGTECH_EU_GENERATION("ami.sort.gregtech_eu_generation", true),
        GREGTECH_EU_CONSUMPTION("ami.sort.gregtech_eu_consumption", true),
        GREGTECH_EU_INPUT("ami.sort.gregtech_eu_input", true),
        GREGTECH_EU_OUTPUT("ami.sort.gregtech_eu_output", true),
