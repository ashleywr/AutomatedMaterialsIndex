...
public final class AMICheatMode {
    ...
    public static void giveItem(ResourceLocation itemId) {
        ...
        if (mc.player.getAbilities().instabuild) {
            ...
            if (AmiConfig.cheatGiveMode == CheatGiveMode.CURSOR) {
                com.sanhiruzu.ami.forge.network.AmiPacketHandler.INSTANCE.sendToServer(new AmiCheatGivePacket(new ItemStack(item)));
            } else {
    ...
    public static void giveStack(ResourceLocation itemId) {
        ...
        if (mc.player.getAbilities().instabuild) {
            ...
            if (AmiConfig.cheatGiveMode == CheatGiveMode.CURSOR) {
                ItemStack stack = new ItemStack(item);
                stack.setCount(stack.getMaxStackSize());
                com.sanhiruzu.ami.forge.network.AmiPacketHandler.INSTANCE.sendToServer(new AmiCheatGivePacket(stack));
            } else {
    ...
    public static void deleteCarried() {
        ...
        if (mc.player.getAbilities().instabuild) {
            ...
            com.sanhiruzu.ami.forge.network.AmiPacketHandler.INSTANCE.sendToServer(new AmiCheatGivePacket(ItemStack.EMPTY));
        }
    }
