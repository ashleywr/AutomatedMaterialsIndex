...
public class SearchBarWidget extends EditBox {
    ...
    public void renderWidget(GuiGraphics g, int mouseX, int mouseY, float partialTick) {
        ...
        if (value.isEmpty() && !focused) {
            ...
            g.drawString(font, PLACEHOLDER_HINT, textX, textY, AMITheme.SEARCH_PLACEHOLDER, false);
            g.disableScissor();
    ...
    public void onClick(double mouseX, double mouseY) {
        moveCursorTo(cursorPositionFromMouse(mouseX));
    }

    @Override
    protected void onDrag(double mouseX, double mouseY, double dragX, double dragY) {
        int pos = cursorPositionFromMouse(mouseX);
