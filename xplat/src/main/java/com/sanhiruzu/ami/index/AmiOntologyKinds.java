...
public final class AmiOntologyKinds {
    private static final List<Rule> RULES = List.of(
            ...
            rule("decoration", "access", "ladders", "Ladders & Climbing", c -> c.pathToken("ladder", "rope", "scaffolding", "framework")),
            rule("decoration", "barriers", "bars", "Bars & Grates", c -> c.pathToken("bars", "grate")),
            rule("decoration", "barriers", "chains", "Chains", c -> c.pathToken("chain")),
            rule("decoration", "signage", "markers", "Decals & Markers", c -> c.pathToken("decal", "warning", "arrow", "marker", "label")),
            ...
            rule("food", "prepared", "prepared_meals", "Prepared Meals", c -> c.pathToken("meal", "stew", "soup", "sandwich", "burger", "roll", "salad", "plate", "bowl", "pasta", "pizza", "kebab", "cooked")),
            rule("food", "prepared", "cakes", "Cakes & Pies", c -> c.pathToken("cake", "pie")),
            rule("food", "prepared", "baked_goods", "Baked Goods", c -> c.pathToken("bread", "cookie", "muffin", "pastry")),
            rule("food", "prepared", "preserves", "Preserves & Sweets", c -> c.pathToken("preserves", "mash", "candy", "chocolate", "sweet", "honey")),
            rule("food", "prepared", "beverages", "Beverages", c -> c.pathToken("juice", "tea", "coffee", "wine", "beer", "bottle", "milk", "cider", "cocktail", "whiskey", "eggnog", "chai", "espresso", "drink", "cocoa", "shake", "flask", "liquid")),
            rule("food", "ingredients", "produce", "Produce", c -> c.pathToken("apple", "berry", "berries", "fruit", "melon", "grape", "tomato", "ancient_fruit", "carrot", "potato", "beetroot", "onion", "cabbage", "lettuce", "pepper", "broccoli", "cauliflower", "corn", "cucumber", "barley", "rice")),
            rule("food", "ingredients", "nuts", "Nuts", c -> c.pathToken("nut", "acorn")),
            rule("food", "ingredients", "roe", "Roe", c -> c.pathToken("roe")),
            rule("food", "ingredients", "dairy", "Dairy", c -> c.pathToken("cheese", "milk", "butter")),
            rule("food", "ingredients", "meat", "Meat", c -> c.pathToken("beef", "pork", "chicken", "mutton", "rabbit", "meat", "bacon")),
            rule("food", "ingredients", "fish", "Fish", c -> c.pathToken("fish", "cod", "salmon", "halibut", "herring")),
