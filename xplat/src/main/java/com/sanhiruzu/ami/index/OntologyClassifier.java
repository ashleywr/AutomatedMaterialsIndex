...
public final class OntologyClassifier {
    ...
    private static TagKey<Item> cTag(String path) {
        return TagKey.create(Registries.ITEM, Services.PLATFORM.rl("c", path));
    }
    ...
    private static String[] classifyNonBlockItem(Item item, Identifier id) {
        ...
        if (item == Items.ENCHANTED_BOOK || Services.PLATFORM.hasDefaultItemComponent(item, "STORED_ENCHANTMENTS")) {
            return magic("books");
        }
    ...
    private static boolean isIngredient(Item item, String path) {
        ...
        return item == Items.EGG            // throwable egg; c:eggs may not cover it in all envs
                ...
                || path.equals("scute") || path.equals("turtle_scute") || item == Items.HONEYCOMB
    ...
    private static String classifySpawnEgg(String path) {
        if (!path.endsWith("_spawn_egg")) return "passive";
    ...
    private static String[] armor(String sub) {
        return new String[]{"armor", sub};
    }

    private static String[] tools(String sub) {
        return new String[]{"tools", sub};
    }

    private static String[] magic(String sub) {
        return new String[]{"magic", sub};
    }
    ...
    private static String[] nature(String sub) {
        return new String[]{"nature", sub};
    }

    private static String[] social(String sub) {
        return new String[]{"social", sub};
    }

    private static String[] utility(String sub) {
        return new String[]{"utility", sub};
    }

    private static String[] bestiary(String sub) {
        return new String[]{"bestiary", sub};
    }

    private static String[] decoration(String sub) {
        return new String[]{"decoration", sub};
    }

    private static String[] ingredients(String sub) {
        return new String[]{"ingredients", sub};
    }

    private static String[] misc(String sub) {
        return new String[]{"misc", sub};
    }

    private static String[] geology(String sub) {
        return new String[]{"geology", sub};
    }

    private static String[] masonry(String sub) {
        return new String[]{"masonry", sub};
    }

    // ── Building block shape & material classifiers ───────────────────────────

    private static String[] masonry(String shape, String material) {
        return new String[]{"masonry", shape, material};
    }
