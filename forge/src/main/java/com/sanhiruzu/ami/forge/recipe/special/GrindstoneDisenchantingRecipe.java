...
public class GrindstoneDisenchantingRecipe implements Recipe<net.minecraft.world.Container>, GrindstoneDisenchantingRecipeView {
    ...
    public GrindstoneDisenchantingRecipe(ResourceLocation id, ItemStack enchanted, ItemStack normal, RecipeType<?> type) {
        this.special = new ForgeSpecialRecipeData(normal, type, List.of(Ingredient.of(enchanted)));
        this.id = id;
