...
public class ForgeTooltipHooks implements AmiTooltipRenderer.TooltipHooks {
    @Override
    public List<ClientTooltipComponent> gather(ItemStack stack, List<Component> lines,
        ...
        return ForgeHooksClient.gatherTooltipComponents(stack, lines, image, mouseX, guiWidth, guiHeight, font);
    }
    ...
    public PreResult onPre(ItemStack stack, GuiGraphics g, int mouseX, int mouseY,
        ...
        var e = ForgeHooksClient.onRenderTooltipPre(stack, g, mouseX, mouseY, guiWidth, guiHeight, components, font, positioner);
    ...
    public ColorResult onColor(ItemStack stack, GuiGraphics g, int x, int y,
        ...
        var e = ForgeHooksClient.onRenderTooltipColor(stack, g, x, y, font, components);
