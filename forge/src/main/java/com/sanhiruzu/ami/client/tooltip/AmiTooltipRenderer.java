...
public final class AmiTooltipRenderer {
    ...
    private static void renderLeftOfCursor(GuiGraphics g, Font font, List<Component> lines,
        ...
        List<ClientTooltipComponent> components = net.minecraftforge.client.ForgeHooksClient.gatherTooltipComponents(
    ...
    private static void render(GuiGraphics g, Font font, List<ClientTooltipComponent> components,
        ...
        var preEvent = net.minecraftforge.client.ForgeHooksClient.onRenderTooltipPre(
        ...
        g.pose().pushPose();
        var colorEvent = net.minecraftforge.client.ForgeHooksClient.onRenderTooltipColor(
